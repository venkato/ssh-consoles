...
import net.sf.jremoterun.utilities.nonjdk.idwutils.IdwUtils2
...
//    private static final Logger log = LogManager.getLogger();
    ...
    boolean onEnterMyPassword(Component input){
        ...
        if(SshConSet2.myPasswordEnter==null){
            throw new IllegalStateException("Password not set")
        }
        String password98 = SshConSet2.myPasswordEnter.readMyPassword(ttyConnector)
        if (password98 == null) {
            throw new IllegalStateException("Password not set")
        }
